...
class enviarPeriodoPrueba extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'emp:enviarPP';
    ...
    public function handle()
    {
        ...
        $empleados =  Terceros::select(
            ...
            ->where(
                'cz9_fecha_tpprueba',  $fecha
            )->get();
             
       if($empleados != '[]'){
        Mail::to('adavidparra0412@gmail.com')->send(new PeriodoPrueba($empleados, $fecha));
    }
