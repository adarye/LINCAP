<template>
    <div>
        ...
        <form @submit.prevent="update()" v-if="modoEditar">
            ...
            <input type="text" class="form-control mb-2" v-model="usuario.cz1_password" />
        ...
        <form @submit.prevent="buscarTercero()" v-else>
            ...
            <input type="text" class="form-control mb-2" placeholder="Numero de cedula" v-model="usuario.cz1_cc" />
            <input type="password" class="form-control mb-2" placeholder="Contraseña" v-model="usuario.cz1_password" />
