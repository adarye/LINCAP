...
<p>A estos trabajadores se le vencerá el carnét de alimentos entre <b> {{\Carbon\Carbon::parse($fecha)->format('d/m/Y')}}</b> y <b>{{\Carbon\Carbon::parse($fecha2)->format('d/m/Y')}}</b></p>
<?php  $i = 1 ?>
<table>
  <tr>
    <th>Row</th>
