    ...
    <div v-show="id_creador == id_log">
        ...
        />
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li v-if=" $route.params.cat == 1" class="breadcrumb-item"><i class="fa fa-pencil"></i> <router-link v-bind:to="'/gestion/pruebas/' + $route.params.cat + '/' + id_log"> Encuestas</router-link></li>
                 <li v-if=" $route.params.cat == 2" class="breadcrumb-item"><i class="fa fa-file-text"></i> <router-link v-bind:to="'/gestion/pruebas/' + $route.params.cat + '/' + id_log" > Evaluaciones</router-link></li>
                <li class="breadcrumb-item">{{datos.cz3_nombre}}</li>
                <li class="breadcrumb-item"><i class="fa fa-gears"></i> Administrar</li>
