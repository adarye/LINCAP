...
_:"Copiando %d filas al portapapeles"},a.rows),2E3);return}catch(i){}}a=g("<span>"+b.i18n("buttons.copyKeys","Presione <i>ctrl</i> or <i>âŒ˜</i> + <i>C</i> Para copiar los datos de la tabla<br>en el portapapeles del sistema.<br><br>Para cancelar, haga clic en este mensaje o pulse Esc.")+"</span>").append(e);b.buttons.info(b.i18n("buttons.copyTitle","Copiar al portapapeles"),a,0);c[0].focus();c[0].select();var h=g(a).closest(".dt-button-info"),m=function(){h.off("click.buttons-copy");g(f).off(".buttons-copy");b.buttons.info(!1)};h.on("click.buttons-copy",
