...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primera",sLast:"Ultima",sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No hay registros",sInfo:"Pagina _START_ Registro _END_ de _TOTAL_ ",sInfoEmpty:"Pagina 0 Registro 0 de 0 ",
sInfoFiltered:"(Filtrado de un total de _MAX_ registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Ver _MENU_ Registros",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"",sSearchPlaceholder:"Buscar...",sUrl:"",sZeroRecords:"No se encontrarón registros"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
